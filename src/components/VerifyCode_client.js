                            ...
                            <KeyboardAvoidingView behavior={'padding'} style={styles.keyboardAvoid}>
                                <Form style={{ width: '100%' , marginTop:30}}>
                                    ...
                                    <Item style={styles.loginItem} bordered>
                                        ...
                                        <Input placeholder={'الرجاء ادخال كود التحقق'} placeholderTextColor={COLORS.placeholderColor} onChangeText={(verifyCode) => this.setState({verifyCode})} keyboardType={'number-pad'} style={styles.input}  />
                                    </Item>

                                    <Item style={styles.loginItem} bordered>
                                        <Label style={[styles.label ]}>{ i18n.t('newPass') }</Label>
                                        <Input placeholder={'الرجاء ادخال كلمة المرور الجديدة'} placeholderTextColor={COLORS.placeholderColor} autoCapitalize='none' onChangeText={(newPass) => this.setState({newPass})} secureTextEntry={this.state.showNewPass === true ? true : false} style={styles.input}  />
                                    ...
                                    <Item style={styles.loginItem} bordered>
                                        ...
                                        <Input placeholder={'تأكيد كلمة المرور الجديده'} placeholderTextColor={COLORS.placeholderColor} autoCapitalize='none' onChangeText={(verifyNewPass) => this.setState({verifyNewPass})} secureTextEntry={this.state.showVerifiedPass === true ? true : false} style={styles.input}  />
